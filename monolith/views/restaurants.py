...
from monolith.forms import CreateRestaurantForm, CreateTableForm, UserForm
...
def restaurant_sheet(restaurant_id):
    records = db.session.query(Restaurant, Precautions, RestaurantsPrecautions).filter(Restaurant.id==int(restaurant_id), Restaurant.id==RestaurantsPrecautions.restaurant_id, RestaurantsPrecautions.precautions_id==Precautions.id).all() #Join between tabels Restaurant, RestaurantsPrecautions and Precautions
